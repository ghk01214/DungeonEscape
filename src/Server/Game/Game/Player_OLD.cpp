...
namespace game
{
	...
	CPlayer_OLD::CPlayer_OLD(Trans trans) :
		CObject{ trans },
		m_aniIndex{ 0 },
		m_aniFrame{ 0.f },
		m_jump{ false },
	...
	CPlayer_OLD::CPlayer_OLD(PosOLD pos, QuatOLD quat) :
		CObject{ pos, quat },
		m_aniIndex{ 0 },
		m_aniFrame{ 0.f },
		m_jump{ false },
	...
	CPlayer_OLD::CPlayer_OLD(float x, float y, float z) :
		CObject{ x, y, z },
		m_aniIndex{ 0 },
		m_aniFrame{ 0.f },
		m_jump{ false },
	...
	CPlayer_OLD::CPlayer_OLD(float x, float y, float z, float w) :
		CObject{ x, y, z, w },
		m_aniIndex{ 0 },
		m_aniFrame{ 0.f },
		m_jump{ false },
	...
	CPlayer_OLD::CPlayer_OLD(float px, float py, float pz, float qx, float qy, float qz, float qw) :
	...
	void CPlayer_OLD::Init()
	{
	}

	void CPlayer_OLD::Transform(uint8_t keyInput, server::KEY_STATE keyState, float deltaTime)
	{
