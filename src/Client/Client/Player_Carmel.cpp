...
void Player_Carmel::Start()
{
	...
	GetNetwork()->SendAddPlayer(server::FBX_TYPE::CARMEL);
...
void Player_Carmel::Update(void)
{
	if (GetNetwork()->IsMyPlayer() == false)
		return;
...
void Player_Carmel::UpdateFrameRepeat()
{
	switch (m_currState)
	{
...
void Player_Carmel::UpdateFrameOnce()
{
	switch (m_currState)
	{
...
void Player_Carmel::KeyInputStateChange()
{
	switch (m_currState)
	{
		case ATK0: case ATK1: case ATK2: case ATK3: case ATK4:
...
void Player_Carmel::DecidePlayerDeath()
{
	if (m_hp <= 0)
		m_currState = DIE0;
}

float Player_Carmel::GetAngleBetweenVector(const XMVECTOR& vector1, const XMVECTOR& vector2)
{
...
void Player_Carmel::TurnPlayer(Vec3 from, Vec3 to)
{
...
void Player_Carmel::MovePlayerCameraLook(void)
{
...
void Player_Carmel::ParsePackets()
{
...
void Player_Carmel::StartRender(network::CPacket& packet)
{
...
void Player_Carmel::Transform(network::CPacket& packet)
{
	int32_t id{ packet.ReadID() };
...
void Player_Carmel::ChangeAnimation(network::CPacket& packet)
{
	if (m_currState != DEAD)
	{
...
void Player_Carmel::AddColliderToObject(network::CPacket& packet)
{
