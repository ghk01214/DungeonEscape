...
shared_ptr<CGameObject> Creator::CreateUIObject(shared_ptr<Texture> texture, shared_ptr<Shader> shader, bool visible)
{
	std::shared_ptr<CGameObject> obj = std::make_shared<CGameObject>();
...
shared_ptr<CGameObject> Creator::CreatePopUpObject(shared_ptr<Texture> texture, shared_ptr<Shader> shader, bool visible, bool blur)
{
	std::shared_ptr<CGameObject> obj = std::make_shared<CGameObject>();
